...
export default function ResumeMakerPage() {
  ...
  return (
    <div className="resume-maker-wrapper">
      ...
      <main
        className="resume-maker-content"
        style={{
          color: "#000",
          background: "linear-gradient(135deg, #ffe5b4 0%, #b4e0ff 100%)",
          minHeight: "100vh",
          borderRadius: "24px",
          position: "relative",
          overflow: "hidden",
      ...
      >
        ...
        <div
          style={{ textAlign: "center", marginBottom: "1.5rem", minHeight: 24 }}
        >
          {aiError && (
            <div style={{ color: "#d90429", fontWeight: 500 }}>{aiError}</div>
          )}
          {saved && (
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      color: activeSection === step.key ? "#0077b6" : "#333",
                      fontSize: 15,
                    }}
                  >
                    {step.label}
